...
from transformers.models.bert_dim_pos import BertDimPosConfig, BertDimPosForMaskedLM
...
def main(model_name):
    ...
    model = BertDimPosForMaskedLM(config).to(device)
    ...
    print("\n===== GÉNÉRATION DE DONNÉES SYNTHÉTIQUES POUR L'ÉVALUATION =====")
    eval_temp_file = generate_pretraining_data(tokenizer, size=10000, filename="data/eval_synthetic.txt")
